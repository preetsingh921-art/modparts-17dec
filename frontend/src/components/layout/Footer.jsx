...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900/95 backdrop-blur-sm text-white py-8 border-t border-gray-700">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4 group">
              ...
              <h3 className="text-xl font-bold group-hover:text-green-400 transition-colors">ModParts</h3>
            </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p className="text-gray-400">
            ...
            <span className="text-green-400 ml-1">Quality Parts, Trusted Service</span>
          </p>
        </div>
      </div>
    </footer>
